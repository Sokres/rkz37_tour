...
import cl from './KamchatkaDopInfo.module.css';
import 'swiper/css';
import 'swiper/css/navigation';
import 'swiper/css/effect-cards';
const KamchatkaDopInfo = () => {
	const { lang, translations } = useLang();
	const imeges = translations[lang].listObject.Kamchatka.img;
	const targetAudience = translations[lang].tour4.target_audience;
	const packing = translations[lang].tour4.packing;
	const tourIncludes = translations[lang].tour4.tour_includes;
	return (
...
export default KamchatkaDopInfo;
